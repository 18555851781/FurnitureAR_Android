...
using StandardAR.HelloAR;

public class StandardARSLAMController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (GetComponentInParent<ARCoreSession>().SessionConfig.SLAMAlgorithmMode == ApiAlgorithmMode.Back_RGB)
        {
        ...
        if(GetComponentInParent<ARCoreSession>().SessionConfig.HandGestureAlgorithmMode == ApiAlgorithmMode.Back_RGB)
        {
