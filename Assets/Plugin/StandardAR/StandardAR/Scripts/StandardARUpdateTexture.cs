...
public class StandardARUpdateTexture : MonoBehaviour {
    ...
    private StandardARCameraPose standardARCameraPose;
	...
	void Start () {
        ...
        standardARCameraPose = GetComponent<StandardARCameraPose> ();
