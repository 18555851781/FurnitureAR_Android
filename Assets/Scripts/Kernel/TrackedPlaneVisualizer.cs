...
//			m_MeshRenderer.material.SetColor("_GridColor", k_PlaneColors[0 % k_PlaneColors.Length]);
...
//			if (_AreVerticesListsEqual(m_PreviousFrameMeshVertices, m_MeshVertices))//||m_MeshVertices.Count==0)
//            {
////				m_Mesh.Clear();
//                return;
//            }
            ...
            for (int i = 0; i < planePolygonCount; ++i)
            {
				...
				//Debug.Log ("yyjv:"+v.x+","+v.y+","+v.z);
				//Debug.Log ("yyjcenter:"+m_PlaneCenter.x+","+m_PlaneCenter.y+","+m_PlaneCenter.z);
