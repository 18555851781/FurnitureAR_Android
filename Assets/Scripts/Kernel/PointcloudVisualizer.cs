...
//			m_showCloud = true;
        ...
        public void Update()
        {
   //         if (!StandardARSLAMController.IsSlamStart) {
			//	m_Mesh.Clear ();
			//	Array.Clear (m_Points, 0, k_MaxPointCount);
			//	return;
			//}
...
//		public void CloundButtonDown(){
//			m_showCloud = !m_showCloud;
//		}
//
//		public void AxisButton(){
//			showAixs = !showAixs;
//			if (showAixs) {
//				Axis.SetActive (true);
//			} else {
